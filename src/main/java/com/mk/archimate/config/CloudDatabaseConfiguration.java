package com.mk.archimate.config;
...
@Configuration
@EnableMongoRepositories("com.mk.archimate.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.mk.archimate.config.dbmigrations");
